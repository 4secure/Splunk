...
$(function() {
    ...
    $.ajax({
        url: 'https://web.archive.org/web/20230706125720/https://api.github.com/repos/rfsp/sizing/issues',
        data: {
            'labels': 'enhancement'
        }
    }).done(function(data) {
...
/*
     ...
     INTERNET ARCHIVE ON 11:37:10 Nov 15, 2023.
...
/*
playback timings (ms):
  captures_list: 709.274
  exclusion.robots: 0.133
  exclusion.robots.policy: 0.119
  cdx.remote: 0.089
  esindex: 0.013
  LoadShardBlock: 655.804 (3)
  PetaboxLoader3.datanode: 634.752 (5)
  load_resource: 133.212 (2)
  PetaboxLoader3.resolve: 72.931 (2)
*/